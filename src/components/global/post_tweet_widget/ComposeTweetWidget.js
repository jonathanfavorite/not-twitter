      ...
      <div className={`compose_tweet_wrap`}>
        <div className='compose_tweet_input_area'>
          ...
          <div className='compose_tweet_details'>
            ...
            <div className='compose_tweet_buttons_wrap'>
              {composeInputOptions.map((item, index) => {
                return (
                  <React.Fragment key={index}>
                    <div className='compose_tweet_button compose_tweet_button_icons_indi'>
                    <div className='compose_tweet_button_icons'>
                      <svg viewBox='0 0 24 24' aria-hidden='true'>
                        <g>
                          ...
                          {item.circles &&
                            item.circles.map((circle, index1) => {
                              return <React.Fragment key={index1}>{circle}</React.Fragment>
                            })}
                        </g>
                      </svg>
                    </div>
